...
int main(int argc, char **argv) {
	...
	rosNode.param<double>("x_dist", x_dist, 2.0);
	rosNode.param<double>("y_dist", y_dist, 2.0);
	rosNode.param<string>("imu_topic", imu_topic, "/imu");
	...
	ros::Subscriber imuSub = rosNode.subscribe("/imu", 1, imuCallback);
